                    ...
                    <div class="card" style="height: 250px;">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 ">
                                    <button class="float-right btn btn-primary"> + Add Qualification</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card " style="height: 250px;">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 ">
                                    <button class="float-right btn btn-primary"> + Add Experience / Training</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card " style="height: 250px;">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 ">
                                    <button class="float-right btn btn-primary"> + Add Address</button>
                                </div>
                            </div>
                        </div>
                    </div>
