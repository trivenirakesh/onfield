...
$("#endpicker").datetimepicker({format: 'HH:mm:ss'});
$('#startdate').datetimepicker({format: 'Y-MM-DD'});
$('#enddate').datetimepicker({format: 'Y-MM-DD'});
$(".fullDayOffCheckbox").click(function(){
...
$(document).ready(function () {
    ...
    $("#module_form").validate({
        ...
        submitHandler: function (form, e) {
            ...
            if($('.fullDayOffCheckbox').prop('checked') == true){
                formData.append('all_day',1);
            }else{
